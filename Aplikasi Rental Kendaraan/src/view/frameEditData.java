...
//    public datarental getDataRental() {
//    datarental dp = new datarental();
//    
//    dp.setNama_customer(JTxtNamaCustomer.getText());
//    dp.setNo_telp_customer(JTxtnoHp.getText());
//    
...
//    }
//    
//    dp.setNama_kendaraan(JDropKendaraan.getSelectedItem().toString());
//    dp.setLama_waktu_sewa(Integer.parseInt(JFieldLamaSewa.getText()));
//    dp.setBiaya_perjam(Integer.parseInt(JFieldBiayaPerjam.getText()));
//    dp.setTotal_biaya(Integer.parseInt(JFieldTotalBiaya.getText()));
//    
//    return dp;
//}
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
        dc.update(dataRental.getKode_rental());
        dc.isitabel();
