...
private int totalBiaya;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Cari data perentalan yang ingin anda cari...");
    ...
    rentalTerpilih.setKode_rental(koderental);   
    ...
    if (baris != -1) {
        koderental = (int)tabelDatarental.getValueAt(baris, 0);
